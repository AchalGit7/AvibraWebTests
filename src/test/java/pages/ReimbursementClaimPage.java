...
public class ReimbursementClaimPage extends PageObject {
        ...
        @FindBy(xpath = "//a[contains(text(), 'Reimbursement Claim')]")
        private WebElementFacade reimbursementClaimButton;
        ...
        private WebElementFacade reimbursementClaimFiledTxt;

        @FindBy(xpath = "//div/span[contains(text(), 'Available Appointments')]")
        private WebElementFacade appointmentTxt;

        @FindBy(xpath = "//button[contains(text(), 'Cancel')]")
        private WebElementFacade cancelReimburseButton;

        @FindBy(xpath = "//button[text() = 'Yes']")
        private WebElementFacade cancelYesReimburseButton;
...
//	}
        ...
        public void enterEmail() {
            String emailAddress = PropertyUtils.getProperty("hyla.reimbusername");
            WaitUtils.waitForElementToAppear(getDriver(), emailAddressField);
            emailAddressField.sendKeys(emailAddress);
        }

        public void enterPassword() {
            String reimbPassword = PropertyUtils.getProperty("hyla.password");
            WaitUtils.waitForElementToAppear(getDriver(), passwordField);
            passwordField.sendKeys(reimbPassword);
        }
        ...
        public void clickReimburseClaimButton(){
            WaitUtils.waitForElementToAppear(getDriver(), reimbursementClaimButton);
            reimbursementClaimButton.click();
        }
        ...
        public WebElement displayReimbClaimFileText(){
            WaitUtils.waitForElementToAppear(getDriver(), reimbursementClaimFiledTxt);
            return reimbursementClaimFiledTxt;
        }

    public void clickReimbCancelBtn(){
        WaitUtils.waitForElementToAppear(getDriver(), cancelReimburseButton);
        cancelReimburseButton.click();
        WaitUtils.waitForElementToAppear(getDriver(), cancelYesReimburseButton);
        cancelYesReimburseButton.click();
    }
    //button[text() = 'Close']
